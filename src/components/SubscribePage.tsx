...
const BANNER = "/images/pages/subcribe/subscribe-page-heading.E-0L70ps.png";
...
export default function SubscribePageView() {
                  ...
                  <div className="field-group field-group-textarea">
                    <div className="row">
                      <div className="col-sm-12">
                        <label htmlFor="sub-intro">Media Introduction</label>
                        <textarea
                          id="sub-intro"
                          rows={5}
